<template>
  <div>
              ...
              <li v-for="(item, index) in cartList" :key="index">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" :class="{'checked': item.checked === '1'}" class="checkbox-btn item-check-btn" @click="editCart ('checked', item)">
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" @click="showModal(item.productId)">
            ...
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:;" @click="toggleCheckAll" >
                  ...
                  <span>{{checkedAllFlag ? 'delete select all' : 'Select all'}}</span>
                </a>
              </div>
            </div>
    ...
    <modal :mdShow='mdShow' @closeModal='closeModal'>
      ...
      <div slot="btnGroup">
        <a href="javascript:;" @click="delCart" class="btn btn--m">确认</a>
        <a href="javascript:;" @click="closeModal" class="btn btn--m btn--red">关闭</a>
      </div>
    </modal>
  </div>
</template>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      toggleCheckAll () {
        let flag = !this.checkedAllFlag ? '1' : '0'
        this.cartList.forEach(item => {
          item.checked = flag
        })
        axios.post('/users/cart/checkAll', {checkAll: flag}).then(res => {
          if (res.data.status === 10001) {
            this.$router.push('/')
          }
        })
